    ...
    db.fetchAll(Collect.category, (result) => {
        ...
        Array.from(categories).forEach((x) => {
            if (x.categoryName === 'Listening') {
                ...
                units.push(Unit.init('Unit 02: Dates', 'Trong phần này chúng ta sẽ học cách đọc ngày tháng nhé.', 'https://data.tienganh123.com/images/avatar/lntacb_unit8.jpg', '', random.int(1000), x._id, Date(), 600000, 'Listening'));
                units.push(Unit.init('Unit 03: Movies', 'Trong phần này, chúng ta cùng nhau tìm hiểu về các thể loại phim nhé.', 'https://data.tienganh123.com/images/avatar/lntacb_unit9.jpg', '', random.int(1000), x._id, Date(), 600000, 'Listening'));
                units.push(Unit.init('Unit 04: Sports', 'Trong bài này, chúng ta cùng tìm hiểu về các môn thể thao.', 'https://data.tienganh123.com/images/avatar/lntacb_unit10.jpg', '', random.int(1000), x._id, Date(), 600000, 'Listening'));
                units.push(Unit.init('Unit 05: Photographs', 'Nghe và cho biêt bức ảnh nói gì?', 'http://i.huffpost.com/gen/1119986/images/o-HOW-PHOTOGRAPHS-BOOST-HAPPINESS-facebook.jpg', '', random.int(1000), x._id, Date(), 600000, 'Listening'));
                
                db.insertMany(Collect.unit, units, (results) => {

                    db.findOne(Collect.unit, {'unitTitle': 'Unit 05: Photographs'}, (result) => {
                        var questions = [];
