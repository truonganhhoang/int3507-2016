...
(7, 'Get started','Get to know Microsoft Edge',
'Welcome to the latest way to surf the web! Microsoft Edge gives you new ways to find stuff, [read](https://support.microsoft.com/en-us/help/17204) and [write](https://support.microsoft.com/en-us/help/17221) on the web, and get help from [Cortana](https://support.microsoft.com/en-us/help/17158), right in the browser. And now you can add [extensions](https://support.microsoft.com/en-us/help/27908) to translate websites, block ads, manage your passwords, and a whole lot more.
...
Whether you''re looking for pictures of penguins or just want to know what the weather is, save time by typing your search directly in the address bar. You’ll get search suggestions, instant results from the web, and your browsing history, on the spot.',
'https://support.microsoft.com/en-us/help/17170/windows-10-get-to-know-microsoft-edge'),
(7,'Get started','Import favorites in Microsoft Edge',
