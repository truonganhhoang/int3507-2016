...
Wi‑Fi network icon in the taskbar
...
(6,'Fix Bluetooth problems in Windows 10: FAQ','','

[Connecting your Windows 10 PC to different Bluetooth devices](https://support.microsoft.com/en-us/help/17156/windows-10-connect-to-bluetooth-devices) lets you do a lot of things on your PC. For example, you can: 

    * Use a Bluetooth mouse or keyboard.

    * [Share files over Bluetooth](https://support.microsoft.com/en-us/instantanswers/6557ff2e-8525-2602-4ec0-cdca49957614/share-files-over-bluetooth) with other tablets, laptops, PCs, and phones.
...
Bluetooth is missing in Settings or can’t be turned on. How can I try to fix this?
...
Bluetooth doesn’t appear in Device Manager after I upgraded from a previous version of Windows to Windows 10. How can I fix this?
...
I updated my PC to a newer version of Windows 10, and now my Bluetooth device doesn’t work anymore. How can I fix this?
...
My Bluetooth device shows as Paired, but it isn’t working. How do I fix this?
...
Help… I can’t  send or receive files over Bluetooth
...
My audio quality is low when Bluetooth settings is open. What can I do to try to fix this?
...
Music doesn’t play over my Bluetooth speaker. How can I fix this?
...
[Learn more about fixing Bluetooth problems](https://support.microsoft.com/en-us/help/14169/windows-10-fix-bluetooth-problems).
