...
(11,'Recovery options in Windows 10','Get started','If you"re having problems with your PC, the following table can help you decide which recovery option to use.
Problem :Your PC isn"t working well because of a recently installed app, driver, or update.
See this section : Restore from a system restore point.
Problem :Your PC isn"t working well and you"re not sure why.
See this section :Reset your PC.
Problem :You want to clear all your personal data off of your PC before you donate or recycle it.
See this section :Reset this PC > Remove everything > Remove files and clean this drive.
Problem :Your PC won"t start.
See this section :If you’ve previously created a USB recovery drive
...
Problem : You recently updated to the latest version of Windows 10, and you want to go back to your previous version of Windows.
See this section :Go back to an earlier build
